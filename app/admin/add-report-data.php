          ...
          <form method="post" class="form-horizontal">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="ctr" value="<?php echo $report['ctr'] ?>">
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-3 control-label">Unit Price</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="unit_price" value="<?php echo $report['unit_price'] ?>">
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-3 control-label">Spent</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="spent" value="<?php echo $report['spent'] ?>">
                </div>
              </div>
