...
if(isset($_REQUEST['delete'])){
  $campaign->deleteCamp($_REQUEST['delete']);
}
?>
<!DOCTYPE html>
<html>
          ...
          <div class="row">
            <div class="col-md-10">
              <form class="row">
                ...
                <div class="col-md-2">
                  <input type="text" name="id" class="form-control" placeholder="Campaign ID" value="<?php echo $_REQUEST['id'] ?>">
                </div>
                <div class="col-md-3">
                  <input type="text" name="advertiser" class="form-control" placeholder="Advertiser Name / ID" value="<?php echo $_REQUEST['advertiser'] ?>">
                </div>
                <div class="col-md-2">
          ...
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="word-break: break-all;"><?php echo htmlspecialchars_decode($camp['name']); ?><?php $permodel=$performancemodel->getPerformanceModelByID($camp['performodel']); if($permodel['name']=='Adult'||$permodel['name']=='adult'){
                ...
                <td>
                  ...
                  <a onclick="return confirm('Are you sure?')" href="?delete=<?php echo md5($camp['id']); ?>" class="btn btn-sm btn-default">
