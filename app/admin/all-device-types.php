...
if(isset($_REQUEST['delete'])){
  $devices->delete($_REQUEST['delete']);
}
?>
<!DOCTYPE html>
<html>
      ...
      <div class="box">
        <div class="box-header with-border">
          ...
          <div class="row">
            ...
            <div class="col-md-2"><a href="new-device.php" class="btn btn-default pull-right">Add New</a></div>
          </div>
        </div>
        <div class="box-body">
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              if(!empty($alldevices['data'])){
                $i=1;
                foreach ($alldevices['data'] as $key => $device) {
              ?>
                  <tr>
                    <td><?php echo $i;//$device['id'] ?></td>
                    <td><img src="<?php echo baseurl.'/public/uploads/'.$device['icon'] ?>" width="100"></td>
                    <td style="vertical-align: middle;"><?php echo $device['name'] ?></td>
                    ...
                    <td style="vertical-align: middle;">
                      <a href="edit-device.php?id=<?php echo md5($device['id']) ?>" class="btn btn-sm btn-default">
                        <i class="fa fa-pencil"></i>
                      </a>
                      <a onclick="return confirm('Are you sure?')" href="?delete=<?php echo md5($device['id']) ?>" class="btn btn-sm btn-default">
        ...
        <div class="box-footer">
          <div class="row" style="margin: 2px 0 !important;">
            ...
            <?php echo $alldevices['pagination'] ?>
          </div>
        </div>
        <!-- /.box-footer-->
      </div>
