...
if(isset($_REQUEST['delete'])){
  $users->deleteMandate($_REQUEST['delete']);
}
?>
<!DOCTYPE html>
<html>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">All Mandates</li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-2 text-right">
              <a href="add-mandate.php" class="btn btn-default">Add Mandate</a>
            </div>
          </div>
          <br/>
          <table  class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="edit-mandate.php?id=<?php echo md5($user['id']); ?>" class="btn btn-sm btn-default"><i class="fa fa-pencil"></i></a>
                  <a onclick="return confirm('Are you sure?')" href="all-mandate.php?delete=<?php echo md5($user['id']); ?>" class="btn btn-sm btn-default">
