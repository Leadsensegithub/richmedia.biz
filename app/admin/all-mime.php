...
if(isset($_REQUEST['delete'])){
  $mimeModule->delete($_REQUEST['delete']);
}
?>
<!DOCTYPE html>
<html>
      ...
      <div class="box">
        <div class="box-header with-border">
          ...
          <div class="row">
            ...
            <div class="col-md-2"><a href="add-mime.php" class="btn btn-default pull-right">Add New</a></div>
          </div>
        </div>
        <div class="box-body">
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              <?php
              $allmime=$mimeModule->getMime();
              if(!empty($allmime['data'])) :
                $i=1;
                foreach ($allmime['data'] as $key => $model) :
              ?>
              <tr>
                <td><?php echo $i;//echo $model['id'] ?></td>
                ...
                <td>
                  <a href="edit-mime.php?id=<?php echo md5($model['id']) ?>" class="btn btn-sm btn-default">
