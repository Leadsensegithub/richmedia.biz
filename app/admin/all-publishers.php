...
if(isset($_REQUEST['delete'])){
  $publishers->delete($_REQUEST['delete']);
}
?>
<!DOCTYPE html>
<html>
      ...
      <div class="box">
        <div class="box-header with-border">
          ...
          <div class="row">
            ...
            <div class="col-md-2"><a href="new-publisher.php" class="btn btn-default pull-right">Add New</a></div>
          </div>
        </div>
        <div class="box-body">
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              <?php
              $allpublishers=$publishers->getPublishers();
              $i=1;
              if(!empty($allpublishers['data'])) :
                foreach ($allpublishers['data'] as $key => $model) :
              ?>
              <tr>
                ...
                <td>
                  <a href="edit-publisher.php?id=<?php echo md5($model['id']) ?>" class="btn btn-sm btn-default">
        ...
        <div class="box-footer">
          <div class="row" style="margin: 2px 0 !important;">
            ...
            <?php echo $allpublishers['pagination'] ?>
          </div>
        </div>
        <!-- /.box-footer-->
      </div>
