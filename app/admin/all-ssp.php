      ...
      <div class="box">
        <div class="box-header with-border">
          ...
          <div class="row">
            ...
            <div class="col-md-2"><a href="new-ssp.php" class="btn btn-default pull-right">Add New</a></div>
          </div>
        </div>
        <div class="box-body">
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              <?php
              $allssp=$ssp->getssp();
              if(!empty($allssp['data'])) :
                $i=1;
                foreach ($allssp['data'] as $key => $model) :
              ?>
              <tr>
                ...
                <td>
                  <a href="edit-ssp.php?id=<?php echo md5($model['id']) ?>" class="btn btn-sm btn-default">
