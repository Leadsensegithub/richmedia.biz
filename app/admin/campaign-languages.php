...
if(isset($_REQUEST['delete'])){
  $campaign_languages->delete($_REQUEST['delete']);
}
?>
<!DOCTYPE html>
<html>
  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Campaign Languages</li>
      </ol>
    </section>
    <!-- Main content -->
      ...
      <div class="box">
        <div class="box-header with-border">
          <div class="row">
            ...
            <div class="col-md-2"><a href="new-campaign-language.php" class="btn btn-default pull-right">Add New</a></div>
          </div>
        </div>
        <div class="box-body">
          <div class="col-md-12">
          ...
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              <?php
              $alllanguages=$campaign_languages->getLanguages();
              if(!empty($alllanguages['data'])){
                $i=1;
                foreach ($alllanguages['data'] as $key => $language) {
              ?>
                  <tr>
                    <td style="width: 50px"><?php echo $i; //$language['id'] ?></td>
                    ...
                    <td style="vertical-align: middle;">
                      <a href="edit-campaign-language.php?id=<?php echo md5($language['id']) ?>" class="btn btn-sm btn-default">
