          ...
          <!-- info row -->
            <div class="row invoice-info">
                ...
                <div class="col-sm-4 invoice-col">
                    ...
                    <address>
                        <small>Name : </small> <strong><?php echo htmlspecialchars_decode($camp['name']) ?></strong>
                        <br>
                    ...
                    <div class="row">
                        ...
                        */
                        ...
                        <div class="col-md-3 col-md-offset-3">
                            ...
                            <?php if($payment['type']=='wallet') : ?>
                                <input type="text" class="form-control"  value="<?php echo number_format($payment['amount'],2) ?>" disabled>
                                <input type="hidden" name="amount" class="form-control" required value="0">
                            <?php else : ?>
                            <input type="text" name="amount" class="form-control" required value="0">
                        <?php endif ?>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-12 text-center mt-1">
                            <a href="<?php echo baseurl.'/admin/payment-transactions.php' ?>" class="btn btn-default">Back</a>
                            <input type="submit" class="btn btn-default" name="update" id="status">
                        </div>
                    </div>
                </form>
            </div>
