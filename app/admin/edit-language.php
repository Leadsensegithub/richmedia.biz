...
if(isset($_REQUEST['id'])){
  $language=$browsers_languages->getLanguageByEncryptID($_REQUEST['id']);
}
if(empty($language)){
  include('404.php');
  die();
...
if(isset($_POST['save'])){
  $browsers_languages->update($_REQUEST['id']);
}
?>
<!DOCTYPE html>
<html>
            ...
            <div class="box-body">
              <form class="forms-sample" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  <label>Name</label>
                  <input type="text" class="form-control" name="name" placeholder="Language Name" value="<?php echo $language['name'] ?>">
                </div>
                <div class="form-group">
                  ...
                  <select multiple name="browsersid[]" class="form-control" required>
                    ...
                    ?>
                        <option <?php echo in_array($browsers['id'],$browsersset) ? 'selected' : '' ?> value="<?php echo $browsers['id'] ?>"><?php echo $browsers['name'] ?></option>
                    <?php
                      }
                    }
                    ?>
