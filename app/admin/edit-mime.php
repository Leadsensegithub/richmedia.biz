...
if(isset($_REQUEST['id'])){
  $model=$mimeModule->getMimeByEncryptID($_REQUEST['id']);
}
if(empty($model)){
  include('404.php');
  die();
  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="all-mime.php">Mime</a></li>
        <li class="active">Edit Mime</li>
      </ol>
    </section>
        ...
        <div class="col-md-offset-3 col-md-6">
          <div class="box">
            <div class="box-header text-center">
              <h3 class="box-title">Edit Mime</h3>
              <hr/>
            </div>
            <div class="box-body">
              <form class="forms-sample" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  <label>Name</label>
                  <input type="text" class="form-control" required id="osname" name="name" placeholder="Name" value="<?php echo $model['name'] ?>">
                </div>
                <div class="form-group">
                  <label>Status</label>
                ...
                <a href="all-mime.php" class="btn btn-default">Back</a>
              </form>
            </div>
          </div>
        </div>
