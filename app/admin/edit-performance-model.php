...
if(isset($_REQUEST['id'])){
  $model=$performancemodel->getperformancemodelByEncryptID($_REQUEST['id']);
}
if(empty($model)){
  include('404.php');
  die();
...
if(isset($_POST['save'])){
  $performancemodel->update($_REQUEST['id']);
}
?>
<!DOCTYPE html>
<html>
  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Campaign Performance Model</li>
      </ol>
    </section>
        ...
        <div class="col-md-offset-3 col-md-6">
          <div class="box">
            <div class="box-header text-center">
              <h4>Edit Performance Model</h4>
              <hr/>
            </div>
            <div class="box-body">
              <form role="form" method="post">
                <div class="form-group">
                  <label>Performance Model Name</label>
                  <input type="text" class="form-control" placeholder="Performance Name" name="name" value="<?php echo $model['name'] ?>">
                </div>
                <div class="form-group">
                  <label>Status</label>
