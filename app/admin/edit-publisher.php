...
if(isset($_REQUEST['id'])){
  $model=$publishers->getPublisherByEncryptID($_REQUEST['id']);
}
if(empty($model)){
  include('404.php');
  die();
  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="all-publishers.php">Domains</a></li>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <form class="forms-sample" method="post" enctype="multipart/form-data">
                ...
                <a href="all-publishers.php" class="btn btn-default">Back</a>
              </form>
            </div>
          </div>
        </div>
