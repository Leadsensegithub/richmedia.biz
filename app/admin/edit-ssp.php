...
if(isset($_REQUEST['id'])){
  $model=$ssp->getSSPByEncryptID($_REQUEST['id']);
}
if(empty($model)){
  include('404.php');
  die();
  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="all-ssp.php">SSP</a></li>
        <li class="active">Edit SSP</li>
      </ol>
    </section>
        ...
        <div class="col-md-offset-3 col-md-6">
          <div class="box">
            <div class="box-header text-center">
              <h3 class="box-title">Edit SSP</h3>
              <hr/>
            </div>
            <div class="box-body">
              <form class="forms-sample" method="post" enctype="multipart/form-data">
                ...
                <a href="all-ssp.php" class="btn btn-default">Back</a>
              </form>
            </div>
          </div>
        </div>
