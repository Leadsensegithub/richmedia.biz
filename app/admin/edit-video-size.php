...
if(isset($_REQUEST['id'])){
  $videos=$videosobj->getVideoByEncryptID($_REQUEST['id']);
}
if(empty($videos)){
  include('404.php');
  die();
  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Video Dimensions</li>
      </ol>
    </section>
        ...
        <div class="col-md-offset-3 col-md-6">
          <div class="box">
            <div class="box-header text-center">
              <h3 class="box-title">Edit Video Dimensions</h3>
              <hr/>
              <div class="col-sm-12">
            ...
            <div class="box-body">
              <form class="forms-sample" method="post" enctype="multipart/form-data">
                ...
                <input type="text" class="form-control" placeholder="Video Dimensions" name="videosize" value="<?php echo $videos['videosize'] ?>">
                </div>
                <div class="form-group">
                  <label>Status</label>
