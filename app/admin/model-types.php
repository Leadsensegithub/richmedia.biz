  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Campaign Models</li>
      </ol>
    </section>
    <!-- Main content -->
      ...
      <div class="box">
        <div class="box-header with-border">
          ...
          <div class="row">
            ...
            <div class="col-md-2"><a href="new-model-type.php" class="btn btn-default pull-right">Add New</a></div>
          </div>
        </div>
        <div class="box-body">
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              <?php
              $allmodels=$models->getModels();
              if(!empty($allmodels['data'])) :
                $id=1;
                foreach ($allmodels['data'] as $key => $model) :
              ?>
              <tr>
                <td><?php echo $model['id'] ?></td>
                <td style="text-align: left;"><?php echo $model['name'].'&nbsp;&nbsp-&nbsp;&nbsp'.$model['type'] ?></td>
                <td>
                  <?php
                  if($model['status']==1){
                ...
                <td>
                  <a href="edit-model-type.php?id=<?php echo md5($model['id']) ?>" class="btn btn-sm btn-default">
