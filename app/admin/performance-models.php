...
if(isset($_REQUEST['delete'])){
  $performancemodel->delete($_REQUEST['delete']);
}
?>
<!DOCTYPE html>
<html>
  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Campaign Performance Models</li>
      </ol>
    </section>
    <!-- Main content -->
      ...
      <div class="box">
        <div class="box-header with-border">
          ...
          <div class="row">
            ...
            <div class="col-md-2"><a href="new-performance-model.php" class="btn btn-default pull-right">Add New</a></div>
          </div>
        </div>
        <div class="box-body">
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              <?php
              $allmodels=$performancemodel->getPerformanceModels();
              ...
              <tr>
                ...
                <td>
                  <a href="edit-performance-model.php?id=<?php echo md5($model['id']) ?>" class="btn btn-sm btn-default">
