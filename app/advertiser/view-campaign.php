        ...
        <section class="invoice">
          ...
          <div class="row invoice-info">
            ...
            ?>
              ...
              <?php if($camp['daily_amount']!='') { ?>
              <small>Daily Amount : </small><strong class="text-capitalize">$<?php echo number_format($camp['daily_amount'],2); ?></strong>
              <?php } ?><br>
              <?php if($camp['cap']!='') { ?>
                <small> Frequency cap 24 hours: </small><strong class="text-capitalize"><?php echo $camp['cap'] ?></strong>
              <?php } ?>
              <br>
            </div>
            <!-- /.col -->
          ...
          <?php if($camp['type']=='Banner'){ ?>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 mt-1">
                    ...
                    <?php echo $camp['image'] ? '<br/><br/><small>URL</small><br/><a href="'.$camp['url'].'" target="_blank">'.htmlspecialchars_decode($camp['url']).'</a>' : '' ?>
                </div>
            </div>
        <?php }else{ ?>
            <div class="row">
                ...
                <div class="col-xs-12 mt-1">
                    ...
                    <?php echo $camp['js'] ? '<br/><br/><small>URL</small><br/><a href="'.htmlspecialchars_decode($camp['url']).'" target="_blank">'.htmlspecialchars_decode($camp['url']).'</a>' : '' ?>
                </div>
            </div>
            <?php } ?>
            ...
            <div class="row">
                ...
                <?php if($video['url']!='') { ?>
                 <div class="col-xs-12 mt-1">
                    ...
                    <strong><pre><?php echo '<a href="'.htmlspecialchars_decode($camp['url']).'" target="_blank">"'.htmlspecialchars_decode($camp['url']).'"</a> '?></pre></strong>
                </div>
                <?php } ?>
        ...
        <?php }elseif ($camp['type']=='Native') { ?>
            ...
            <div class="row">
                ...
                <div class="col-xs-4">
                    ...
                    <strong><?php echo $video['phone'] ?></strong>
                </div>
                <?php } ?>
                ...
                <?php } ?>
                <?php if(!empty($video['image'][2])){ ?>
                <div class="col-xs-4">
                    <a href="<?php echo $video['image'][2] ?>" target="_blank"><img src="<?php echo baseurl.'/public/uploads/'.$video['image'][2] ?>"></a>
                    <?php echo'<a href="'.baseurl.'/public/uploads/'.$video['image'][2].'" download class="btn btn-theme">Download</a>'; ?>
                </div>
                <?php } ?>
            </div>
        <?php } ?>
        ...
        <form method="post">
            <div class="row">
                <div class="col-md-12 text-center">
                     <?php
                    if ( $camp['status']==3 && $camp['editstatus']===NULL && $camp['camppausetype']==1 ) {
                    ?>
                    ...
                    <?php } ?>
                    <a href="<?php echo baseurl.'/advertiser/all-campaigns.php' ?>" class="btn btn-default">Back</a>
                </div>
            </div>
        </form>
