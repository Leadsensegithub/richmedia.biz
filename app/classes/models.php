...
class Models
{
    ...
    {
        $sql="INSERT INTO ".$this->table." SET name='".$_POST['name']."',type='".$_POST['type']."',status='".$_POST['status']."'";
    ...
    {
        $sql="UPDATE ".$this->table." SET name='".$_POST['name']."',type='".$_POST['type']."',status='".$_POST['status']."' WHERE md5(id)='".$id."'";
    ...
    public function getModels($perrow='')
    {
        ...
        if(isset($_GET['key']) && $_GET['key']!=''){
            $sql .=" AND name LIKE '%".$_GET['key']."%' || type LIKE '%".$_GET['key']."%' ";
            $parem .='&key='.$_GET['key'];
        }
