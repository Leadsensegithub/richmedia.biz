...
class Performancemodel
{
    ...
    public function save()
    {
        ...
        if($result){
            ...
            $_SESSION['flash_msg']='New Performance model has been successfully created';
            redirect('performance-models.php');
        }else{
            $_SESSION['flash']=TRUE;
    ...
    public function update($id)
    {
        ...
        if($result){
            $_SESSION['flash']=TRUE;
            $_SESSION['flash_class']='success';
            $_SESSION['flash_msg']='Performance Model was successfully updated';
            redirect('performance-models.php');
        }else{
            $_SESSION['flash']=TRUE;
    ...
    public function delete($id)
    {
        ...
        if($result){
            $_SESSION['flash']=TRUE;
            $_SESSION['flash_class']='success';
            $_SESSION['flash_msg']='Performance Model was successfully deleted';
            redirect('performance-models.php');
        }else{
            $_SESSION['flash']=TRUE;
            $_SESSION['flash_class']='red';
    ...
    public function getPerformanceModelByEncryptID($id)
    {
        $sql="SELECT * FROM ".$this->table." WHERE md5(id)='".$id."'";
        return $this->db->get_row($sql);
    }

    public function getPerformanceModelByID($id)
    {
        $sql="SELECT * FROM ".$this->table." WHERE id='".$id."'";
        return $this->db->get_row($sql);
    }

    public function allPerformanceModels()
    {
        $sql="SELECT * FROM ".$this->table." WHERE deleted_at is NULL ORDER BY name ASC";
        return $this->db->get_results($sql);
    }

    public function getPerformanceModels($perrow='')
    {
        if($perrow){
            $limit = $perrow;
        }else{
        ...
        $pagination=$this->common->getPagination('performance-model.php',$pages,$limit,$cpage=$page,$parem);
