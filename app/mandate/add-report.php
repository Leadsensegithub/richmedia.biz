          ...
          <form method="post" class="form-horizontal">
            ...
            <div class="box-body">
              <div class="col-md-offset-3">
                <table class="table">
                  <thead>
                    ...
                    <tr>
                      <td><small>Daily:</small></td><td><strong><?php echo '$'.number_format($reportcampaign['daily_amount'],2); ?></strong></td>
                    </tr>
                    <tr>
                      <td><small>Budget:</small></td><td><strong><?php echo '$'.number_format($reportcampaign['total_budget'],2); ?></strong></td>
                    </tr>
                  </thead>
                </table>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" onchange="reportCalc('<?php echo $reportcampaign['model'] ?>')" name="unit_price" id="unit_price" value="<?php echo number_format($report['unit_price'],2); ?>">
                </div>
              </div>
              <div class="form-group">
