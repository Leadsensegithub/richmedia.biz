            ...
            <div class="row">
                <div class="col-md-12">
                    <?php //if($camp['mandate_camp_status']==1){ ?>
                        ...
                        <P><textarea name="approvecomment" class="form-control"><?php echo $camp['mandate_comment'] ?></textarea>
                    <?php //} ?>
                </div>
                ...
                <?php */ ?>
                    ...
                    ?>                  <input type="hidden" name="type" value="<?php echo $_SESSION['type']; ?>">
                            ...
                            ?>          <input type="hidden" name="type" value="<?php echo $_SESSION['type']; ?>">
                                        <button type="submit" name="save" onclick="return confirm('Are you sure want to proceed to Approve Campaign')" class="btn btn-success">Approve Campaign</button>
                            <?php   }
                                } 
                            } 
                            ?>
                    ...
                    if(!empty($camph)){
                    ?>
                    <a href="<?php echo baseurl.'/mandate/campaign-history.php?token='.md5($camp['id']) ?>" class="btn btn-default">Campaign History</a>
                <?php } ?>
                    <a href="<?php echo baseurl.'/mandate/all-campaigns.php' ?>" class="btn btn-default">Back</a>
                </div>
            </div>
        </form>
