        ...
        <form method="post">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php }else{ ?>
                        <p class="text-center text-yellow">Awaiting for mandate approval</span></p>
                    <?php } ?>
                </div>
                <div class="col-md-12 text-center">
                    ...
                    ?>                 
                            ...
                            <?php   }elseif(($camp['mandate_camp_status']=='1') && ($camp['status']==1)||($camp['status']==3) && $camp['renewstatus']!=1){ 
                            ?>          <input type="hidden" name="type" value="<?php echo $_SESSION['type']; ?>">
                            ...
                            <?php   }elseif($camp['renewstatus']==1){ ?>
                                        <a class="btn btn-warning disabled">Awaiting Payment</a>
                            <?php 
                                    }
                                } 
                ...
                <?php } ?>
                    <a href="<?php echo baseurl.'/support/all-campaigns.php' ?>" class="btn btn-default">Back</a>
                </div>
            </div>
        </form>
